...
def parse_args():
    ...
    parser.add_argument("--train_json_path", type=str,
                        default=f'/Users/yizeli/PycharmProjects/LAION-Aesthetics-V2-6.5plus/output/train_all.json',
                        help="Path to json file of vocab.")
    parser.add_argument("--val_json_path", type=str,
                        default=f'/Users/yizeli/PycharmProjects/LAION-Aesthetics-V2-6.5plus/output/val_all.json',
                        help="Path to json file of vocab.")
    ...
    parser.add_argument("--cache_dir", type=str, default="/Users/yizeli/PycharmProjects/diffusers",help="Path to cached sdxl")
